<nav class="navbar navbar-expand-lg  navbar-light fixed-top fixed " style="background-color: #f73ae7;            font-weight:bold;">
      <div class="container">


      <div class="logo mr-5" >
      <h2 style="font-family: monotype corsiva; font-size: 40px; font-weight: bold; color: white; ">Ladies Store</h2>
      </div>
